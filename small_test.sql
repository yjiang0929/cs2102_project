insert into customers values ('man','dude','guy','male');
...
insert into freelancers values ('pikachu','jane','doe','female',null,null,1);
insert into freelancers values ('pichu','john','doe','male',null,null,1);
