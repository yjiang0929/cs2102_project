...
insert into tasks values (1,'this task','20190402',1,1,'man','home address');
insert into tasks values (2,'next task','20190403',1,1,'man','another home address');

insert into ContactMethods values ('man','1234567','65');
insert into PaymentMethods values ('1234567887654321','201908','SGD','man');

insert into freelancers values ('lancer','jane','doe','female','1111');
insert into freelancers values ('pichu','john','doe','male','1111');
insert into freelancerspecs values ('lancer',1);
insert into freelancerspecs values ('pichu',1);
...
insert into contracts values (1,'20190405',100,1,'lancer','man',null,'home address');
